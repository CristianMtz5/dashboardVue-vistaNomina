...
export default {
  ...
  data() {
    return {
      items: [
        { title: "Inicio", icon: "mdi-home", link: "/dashboard" },
        {
          title: "Catálogos",
          ...
          model: false,
          children: [
            { title: "CFDI 4.0", icon: "mdi-circle-small", link: "/cfdi4" },
            { title: "Nómina", icon: "mdi-circle-small", link: "/nomina" },
            // { title: "Maps", icon: "mdi-circle-small", link: "/maps" },
          ],
        },
        { title: "Clientes", icon: "mdi-folder-account", link: "/tables" },
        { title: "Typography", icon: "mdi-format-size", link: "/typography" },
        { title: "Ajustes", icon: "mdi-cog", link: "/settings" },
        /* {
          title: "Notifications",
